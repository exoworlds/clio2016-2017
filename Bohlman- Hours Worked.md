...
|9/21/2016         |2.25              |Opened dewar, tried to install astropy, ds9 and other necessary python programs, but couldn't. Starting thread on pyds9 to discuss error. Put temperature sensor inside of dewar and proceeded to reseal it in order to vaccuum it again. Awaiting further instructions.|
...
|11/8/2016         |4             |Spoke with Katie on skype to update each other on the progress being made for data, organized to do list into bullet list/formatted with md, |
